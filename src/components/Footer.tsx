    ...
    <footer className="bg-muted/50 border-t border-border">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Full-stack developer specializing in backend development, AI/ML,
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-8 pt-8 border-t border-border flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0"
        >
          <p className="text-muted-foreground text-sm">
            © {currentYear} Shoabur Rahman Chishty. All rights reserved.
          </p>
